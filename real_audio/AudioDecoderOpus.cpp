...
bool AudioDecoderOpus::initialize()
{
...
bool AudioDecoderOpus::decode(char *data_in, int size_in, char **data_out, int &size_out)
{
	int ret;
	int offset = 0;
	int parsed = 0;
...
bool AudioDecoderOpus::decode(AudioFramePtr &inFrame, AudioFramePtr &outFrame)
{
	int ret;
	int offset = 0;
	int parsed = 0;
