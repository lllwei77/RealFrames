...
AVFrame* VideoDecoderH265::decode(AVPacket *pPacket, int i_counter, int p_counter)
{
...
bool VideoDecoderH265::decode(VideoFramePtr &inFrame, VideoFramePtr &outFrame)
{
